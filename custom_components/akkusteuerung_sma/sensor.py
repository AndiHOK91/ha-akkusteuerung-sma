...
SENSORS: tuple[OptiSensorDescription, ...] = (
    ...
    OptiSensorDescription(
        key="house_consumption_60min_w",
        name="Opti House Consumption 60min W",
        data_key="house_consumption_60min_w",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        attribute_keys={"samples": "house_consumption_60min_samples"},
    ),
    ...
    OptiSensorDescription(
        key="house_battery_load_30_mins",
        name="House Battery Load 30 mins",
        data_key="battery_load_30min_w",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        attribute_keys={"samples": "battery_load_30min_samples"},
    ),
